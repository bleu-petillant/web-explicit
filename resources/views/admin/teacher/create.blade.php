...
@section('admin.teacher.create')
    ...
    <div class="content-header">
        ...
        <form method="POST" action="{{ route('teacher.store') }}">
            ...
            <input hidden type="text" id="role_id" name="role_id" value="2">
            <div>
                <x-jet-label for="prenom" value="{{ __('Prénom du professeur') }}" />
            ...
            <div class="mt-4">
                <x-jet-label for="email" value="{{ __('Email du professeur') }}" />
