<div class="flex space-x-1 justify-around">
    {{-- <a href="{{ route('ressource.show', [$slug]) }}"class="p-1 text-teal-600 hover:bg-teal-600 hover:text-white rounded">
    ...
    <a href="{{ route('reference.edit', [$id]) }}" class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded">
