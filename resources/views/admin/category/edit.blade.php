    ...
    <div class="content-header">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('category.index') }}">Liste des catégories</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <p class="h4 mb-4">Modifier la catégorie - <span class="text-danger font-perso font-italic">{{ $category->name }}</span></p>
